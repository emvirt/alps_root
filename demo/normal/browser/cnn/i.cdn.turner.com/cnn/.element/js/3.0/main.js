// $Id: main.js,v 1.44 2012/07/18 16:46:03 asrinivasan Exp $
...
function cnnRenderDomesticBanner(object){
	...
	switch (object.type) {
		...
		// EDB 4/27/11
        	case 'Royal Wedding':
			img='RW_live_banner.html';
                        imgURL='http://www.cnn.com/SPECIALS/2011/royal.wedding/live/';
                	//dont show royal banner on home page
                	if(document.location.pathname == '/' || document.location.pathname == '/index.html' || document.location.pathname == 'http://weather.edition.cnn.com/SPECIALS/2011/royal.wedding/live/')
                	{
                        	return '';
                	}
                	break;
...
var CNN_SlideShowManagerAlt = (function () {
	...
	var CNN_SlideShow = function (settings) {
		...
		if ( this.explainer === 1) {
			this.imageUrlRoot = this.xmlurl.split('data.html')[0] + 'media/';
...
/* Load the Awesomebar */
Event.observe(window, 'load', function () {
	var get_banner = new Ajax.Request('http://weather.edition.cnn.com/.element/ssi/www/breaking_news/3.0/banner.html', {
		'method': 'get',
		'onSuccess': function(response) {
